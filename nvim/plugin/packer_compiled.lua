...
_G.packer_plugins = {
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/Users/tazgreenwood/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/tazgreenwood/.local/share/nvim/site/pack/packer/opt/packer.nvim",
  ...
  ["vim-dispatch"] = {
    loaded = true,
    path = "/Users/tazgreenwood/.local/share/nvim/site/pack/packer/start/vim-dispatch",
